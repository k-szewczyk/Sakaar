# Generated by Django 2.1.7 on 2019-04-18 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attacker', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='round_attacker', to='halloffame.Hero')),
                ('battle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='round', to='battles.Battle')),
                ('defender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='round_defender', to='halloffame.Hero')),
            ],
        ),
    ]
